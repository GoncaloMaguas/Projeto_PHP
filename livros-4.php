...
<header class="header4">
    <div class="caixa-branca-autor">
        <div class="autor">livros
            <div class="sobre-mim">senhora do amor e da guerra
            </div>
        </div>
...
<header class="header6">
    ...
    <p class="area-texto-livro1">
        <img class="imagem-livro1" src="desktop/imagens/livro-conteudo.jpg" alt="">
        ...
        <br /><br />Edição: Junho de 2020<br /> Dimensões: 150x230x10mm<br />Encadernação: Capa mole<br />Páginas: 240
