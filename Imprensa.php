...
<header class="header7">
    <div class="caixa-imprensa caixa-sombra">
        <div class="titulo-imprensa">lançamento | senhora do amor e da guerra</div>
        <div class="linha-separadora-imprensa">
            <hr>
        </div>
    ...
    <div class="caixa-imprensa">
        <div class="titulo-imprensa margem-de-cima">lançamento do livro "o velho que pensava que fugia"</div>
        <div class="linha-separadora-imprensa">
            <hr>
        </div>
        ...
        <p class="texto-imprensa"></br></br></br>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum consectetur iure laudantium fugiat recusandae nobis nisi, sapiente voluptate neque, a enim dignissimos ipsum voluptatum reprehenderit tempore. Nulla facilis deserunt sequi! </br>
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo expedita nemo, sed, explicabo velit modi, consectetur nesciunt commodi facilis optio error odit eum atque suscipit laudantium obcaecati deleniti repellendus debitis.
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa aperiam quas est labore sit dolores? Tenetur, necessitatibus. Dolores, ea maiores saepe sapiente cumque sequi. Natus quas eveniet ipsa laboriosam eum?</br></br>
            </br>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa perferendis consequatur autem optio. Hic, voluptas nobis, asperiores officiis fugit illo fugiat similique architecto dicta accusamus magni. </br>Blanditiis sit cumque magni?</p>
        <div class="paginacao">

            <a href=""> <img src="desktop/imagens/setaesquerda1.svg" width="17px" height="30px" class="margem-seta-esquerda" alt=""></a>
            <a class="margem-numeracao paginacao-numeros" href="">1</a>
